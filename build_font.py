...
# --- 配置区 ---
OUTPUT_FONT_PATH = "MyPixelFont.ttf"  # 最终生成的像素字体文件名
...
new_font.familyname = "My Pixel Font"
new_font.fontname = "MyPixelFont-Regular"
new_font.fullname = "My Pixel Font Regular"
